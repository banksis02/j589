...
return function(context)
    ...
    if previous and previous.jobId == host.JobId and previous.version == 13 then return previous end
    if previous and previous.stop then previous.stop() end
    ...
    local state = {jobId = host.JobId, version = 13, active = true, tried = {}, pending = nil}

...
if pid == 107778070777162 then
    ...
    task.spawn(function()
        local ok, err = pcall(function()
            local src = game:HttpGet("https://raw.githubusercontent.com/banksis02/j589/main/steal_an_egg_visual_cull.lua?v=2")
    ...
    task.spawn(function()
        local ok, err = pcall(run, "steal_an_egg_auto_hop.lua?v=11", true)
